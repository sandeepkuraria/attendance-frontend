...
//             'https://attendance-api-theta.vercel.app/auth/login',
//             requestOptions,
//           );
//           // console.log(
//           //   'inside login API try block response+++++++++++',
//           //   response,
//           // );
//           const data = await response.json();
//           // console.log('data inside try block___________', data);
//           // console.log('response.ok inside try block___________', response.ok);

//           if (response.ok) {
//             console.log('data.token before Asyncstorage', data.token);
//             await AsyncStorage.setItem('token', data.token);
//             // const storedToken = await AsyncStorage.getItem('token');
//             // console.log('token is stored in Asyncstorage', storedToken);
//             setToken(data.token);

//             await AsyncStorage.setItem('userId', data.userId);
//             // const storedUserId = await AsyncStorage.getItem('userId');
//             // console.log('storedUserId is stored in Asyncstorage', storedUserId);
...
//         },
//         error => {
//           console.error('Error getting locationnnnn:', error);
//           Alert.alert('Error', 'Failed to get user locationnnnnnnnn');
//         },
//         {enableHighAccuracy: false, timeout: 10000, maximumAge: 1000},
//       );
//     } catch (error) {
//       Alert.alert('Error', 'Failed to loginnnnn. Please try again.');
